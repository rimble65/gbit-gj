...
public class FourDotTwo : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        AddContent();
        mom = transform.Find("Mom").gameObject;
    ...
    private void Turn()
    {
        if (pageIndex < contentList.Count - 1)
        {
            ...
            timer = Time.time;
            cursor = 0;
            mom.SetActive(flagList[pageIndex] == 5);
    ...
    private void AddContent()
    {
        ...
        contentList.Add("“老娘没酒喝了出来买，你还管起你老娘了是吧？”"); flagList.Add(5);
        ...
        contentList.Add("“矫情什么啊你？我看这房子好得很，老娘合同都签了，你要老娘反悔？你tm出钱违约？”"); flagList.Add(5);
        ...
        contentList.Add("那个女人打了他一巴掌。“你敢跟老娘扯着嗓子叫？”"); flagList.Add(5);
